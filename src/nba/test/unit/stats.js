...
describe("stats methods", function () {
  ...
  describe("#playerProfile()", () => {
    it("should issue a request to the correct URL", () => stats.playerProfile({PlayerID: 1234}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/playerprofilev2")).toEqual(true)));
  ...
  describe("#playerInfo()", () => {
    it("should issue a request to the correct URL", () => stats.playerInfo({PlayerID: 1}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/commonplayerinfo")).toEqual(true)));
  ...
  describe("#playerSplits()", () => {
    it("should issue a request to the correct URL", () => stats.playerSplits({PlayerID: 2}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/playerdashboardbygeneralsplits")).toEqual(true)));
  ...
  describe("#playersInfo()", () => {
    it("should issue a request to the correct URL", () => stats.playersInfo({Season: "2013-14"}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/commonallplayers")).toEqual(true)));
  ...
  describe("#teamStats()", () => {
    it("should issue a request to the correct URL", () => stats.teamStats({Season: "2012-13"}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/leaguedashteamstats")).toEqual(true)));
  ...
  describe("#teamSplits()", () => {
    it("should issue a request to the correct URL", () => stats.teamSplits({Season: "2011-12"}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/teamdashboardbygeneralsplits")).toEqual(true)));
  ...
  describe("#teamYears()", () => {
    it("should issue a request to the correct URL", () => stats.teamYears({LeagueID: "00"}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/commonteamyears")).toEqual(true)));
  ...
  describe("#shots()", () => {
    it("should issue a request to the correct URL", () => stats.shots({PlayerID: 3}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/shotchartdetail")).toEqual(true)));
  ...
  describe("#scoreboard()", () => {
    it("should issue a request to the correct URL", () => stats.scoreboard({GameDate: "12/25/2014"}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/scoreboard")).toEqual(true)));
  ...
  describe("#playByPlay()", () => {
    it("should issue a request to the correct URL", () => stats.playByPlay({GameID: 1}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/playbyplay")).toEqual(true)));
  ...
  describe("#teamHistoricalLeaders()", () => {
    it("should issue a request to the correct URL", () => stats.teamHistoricalLeaders({TeamID: 7}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/teamhistoricalleaders")).toEqual(true)));
  ...
  describe("#teamInfoCommon()", () => {
    it("should issue a request to the correct URL", () => stats.teamInfoCommon({TeamID: 8}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/teaminfocommon")).toEqual(true)));
  ...
  describe("#commonTeamRoster()", () => {
    it("should issue a request to the correct URL", () => stats.commonTeamRoster({TeamID: 9}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/commonteamroster")).toEqual(true)));
  ...
  describe("#teamPlayerDashboard()", () => {
    it("should issue a request to the correct URL", () => stats.teamPlayerDashboard({TeamID: 10}).then(() => expect(lastUrlEq("https://stats.nba.com/stats/teamplayerdashboard")).toEqual(true)));
